...
(
    ...
    P_USN varchar(20) NOT NULL,
    P_Gender char(20) NOT NULL,
    P_DOB DATE NOT NULL,
    P_contactno numeric(10),
    P_address numeric(6),
    P_email varchar(30),
    PRIMARY KEY(P_id,P_USN),
...
INSERT INTO Location VALUES(560070, "Banshakari 2nd Stage", "Bangalore", "Karnataka");
INSERT INTO Location VALUES(560004, "VV Puram", "Bangalore", "Karnataka");
INSERT INTO Location VALUES(560078, "Jp Nagar", "Bangalore", "Karnataka");
INSERT INTO Location VALUES(560041, "Jayanagar 4th Block", "Bangalore", "Karnataka");
INSERT INTO Location VALUES(560001, "MG Road", "Bangalore", "Karnataka");
INSERT INTO Location VALUES(560066, "Whitefield", "Bangalore", "Karnataka");
INSERT INTO Location VALUES(560034, "Koramangala", "Bangalore", "Karnataka");

INSERT INTO Inventory VALUES(1, "Metas Inventory", 8789234987, 560078);
INSERT INTO Inventory VALUES(2, "Anandibai Inventory", 8056379986, 560004);
INSERT INTO Inventory VALUES(3, "Sanjeevani Inventory", 9882310885, 560066);

INSERT INTO Vaccine VALUES("Covaxin", "Bharat Biotech", 1000);
INSERT INTO Vaccine VALUES("Covishield", "AstraZeneca", 1500);
INSERT INTO Vaccine VALUES("Sputnik", "Gamaleya Research Institute", 1800);
